...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("yolo", "Toggle guarded YOLO mode for this session",
               "Configuration", busy_policy="dispatch"),
    CommandDef("approvals", "Show or set the persistent dangerous-command approval mode",
               "Configuration", args_hint="[manual|smart|guarded_yolo|off]",
               subcommands=("manual", "smart", "guarded_yolo", "off")),
