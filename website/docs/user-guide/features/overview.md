...
- **[Process-Driven Persistent Agent](/guides/process-driven-persistent-agent)** — Combine durable state, deterministic `wakeAgent` gates, bounded model turns, and fixed checkpoints to approximate always-on productivity without continuous inference.
